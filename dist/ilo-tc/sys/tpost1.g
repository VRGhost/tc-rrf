...
; ------ get_nozzle_temp(var.curToolTemp, 1)
...
if 1 >= 0
    ; Valid tool ID
    while var.cur_tool_heater_idx_1 < #tools[1].heaters
        set var.cur_heater_idx_0 = tools[1].heaters[var.cur_tool_heater_idx_1]
...
; ------ get_target_tool_temp(var.targetToolTemp, 1)
...
if 1 >= 0
    ; Valid tool ID
    while var.cur_tool_heater_idx_3 < #tools[1].heaters
        set var.cur_heater_idx_2 = tools[1].heaters[var.cur_tool_heater_idx_3]
