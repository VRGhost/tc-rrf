...
; ------ get_nozzle_temp(var.curToolTemp, 2)
...
if 2 >= 0
    ; Valid tool ID
    while var.cur_tool_heater_idx_1 < #tools[2].heaters
        set var.cur_heater_idx_0 = tools[2].heaters[var.cur_tool_heater_idx_1]
...
; ------ get_target_tool_temp(var.targetToolTemp, 2)
...
if 2 >= 0
    ; Valid tool ID
    while var.cur_tool_heater_idx_3 < #tools[2].heaters
        set var.cur_heater_idx_2 = tools[2].heaters[var.cur_tool_heater_idx_3]
