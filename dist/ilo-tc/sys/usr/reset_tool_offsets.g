...
; ---- T0
; --- apply_tool_offsets(0, {'X': 20.77, 'Y': 44.22, 'Z': -4.66})
G10 P0 X20.7700 Y44.2200 Z-4.6600
; --- apply_tool_offsets() END
; ---- T1
; --- apply_tool_offsets(1, {'X': 20.48, 'Y': 43.73, 'Z': -4.6})
G10 P1 X20.4800 Y43.7300 Z-4.6000
; --- apply_tool_offsets() END
; ---- T2
