...
; ---- T0
; --- apply_tool_offsets(0, {'X': 20.77, 'Y': 44.22, 'Z': -4.897})
G10 P0 X20.7700 Y44.2200 Z-4.8970
; --- apply_tool_offsets() END
; ---- T1
; --- apply_tool_offsets(1, {'X': 20.48, 'Y': 43.73, 'Z': -4.887})
G10 P1 X20.4800 Y43.7300 Z-4.8870
; --- apply_tool_offsets() END
; ---- T2
; --- apply_tool_offsets(2, {'X': -8, 'Y': 39.2, 'Z': -4.1})
G10 P2 X-8 Y39.2000 Z-4.1000
; --- apply_tool_offsets() END
; ---- T3
